...
LABEL org.opencontainers.image.source="https://github.com/R2-Engineering/agent_deployment_demo"
...
CMD ["gunicorn", "-k", "uvicorn.workers.UvicornWorker", "app.main:app", "--bind", "0.0.0.0:8000", "--workers", "2", "--threads", "4", "--timeout", "30"]
